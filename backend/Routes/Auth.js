...
router.post('/foodData', async (req, res) => {
    try {
        console.log("inside food data router post method");
       
        console.log("fooddata is" +JSON.stringify(global.foodData));  
          console.log("foodcategory is" +JSON.stringify(global.foodCategory));
